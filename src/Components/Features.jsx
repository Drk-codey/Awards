      ...
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]'>
          <BentoCard 
            ...
            title={<>radi<b>n</b>t</>} 
            description="A cross-platform metagame app, turning your activities across Web2 and Web3 gamnes into a rewarding adventure." 
            isComingSoon
          />
        </BentoTilt>

        <div className='grid h-[135vh] grid-cols-2 md:grid-cols-4 grid-rows-3 gap-7'>
          <BentoTilt className='bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2 md:border-red-500'>
            <BentoCard 
